...
#ifdef SIMPLE_MODEL
#define MAX_SERIAL_ADMC 0
#define MAX_SERIAL_ADMR 0
#define MAX_SERIAL_BESS 0
#define MAX_SERIAL_BUYC 0
#define MAX_SERIAL_BUYR 0
#define MAX_SERIAL_CREG 0
#define MAX_SERIAL_HOME 0
#define MAX_SERIAL_NEWP 0
#define MAX_SERIAL_ORDD 0
#define MAX_SERIAL_ORDI 0
#define MAX_SERIAL_PROD 0
#define MAX_SERIAL_SREQ 0
#define MAX_SERIAL_SRES 0
#define MAX_SERIAL_SHOP 0
#else
...
class Client {
    ...
    private:
        ...
        int get_page_image_num ( int request_type);
